...
<head>
    ...
    <title>Zhongguocha - Інтернет магазин</title>
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="display_tea.php">Чай</a>
          </li>
  ...
  <!--third, заголовок-->
  <div class="bd-light">
    <h3 class="text-center">Асортимент чаю</h3>
  </div>
  <!--fourth-->
  <div class="row px-1">
      <!-- sidenav -->
    ...
    <div class="col-md-10">
      ...
      <div class="row">
        <?php
          get_all_products(); //all products show
          get_unique_category();
          get_unique_brand();
        ?>
      </div>
